...
Dynamic Search: An intuitive search bar to help users find specific entries within the Elden Ring database.

## Technical Stack
Language: Java (Desktop version)

Logic: Implemented custom filtering algorithms to compare user guesses against character attributes.

Data Management: Organized game data into structured objects for efficient comparison and state management.
